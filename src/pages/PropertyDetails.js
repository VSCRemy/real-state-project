      ...
      <div className="container mx-auto min-h-[800px] mb-14">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="mb-4 lg:mb-0 flex gap-x-2 text-sm">
            ...
            <div className="bg-sky-500 text-white px-3 rounded-full">
              {house.country}
            </div>
          </div>
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          <div className="max-w-[768px]">
            ...
            <div className="flex gap-x-6 text-sky-700 mb-6">
          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
            <div className="flex items-center gap-x-4 mb-8">
              ...
              <div>
                ...
                <Link to="/" className="text-sky-700 text-sm">
                  View Listings
                </Link>
              </div>
            </div>
            <form className="flex flex-col gap-y-4">
              ...
              <textarea
                ...
                placeholder="Message"
                defaultValue="Hi, Im interested in this listing."
              ></textarea>
              <div className="flex gap-x-2">
                <button className="bg-sky-700 hover:bg-sky-800 text-white rounded p-4 text-sm w-full transition">
                  Send message
                </button>
                <button className="border border-sky-700 text-sky-700 hover:border-sky-500 hover:text-sky-500 rounded p-4 text-sm w-full transition">
                  Call
                </button>
              </div>
            </form>
